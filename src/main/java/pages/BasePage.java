...
public class BasePage {
    ...
    public WebElement getShadowRootElement(String rootElementId, String cssLocator){
        String script = String.format("return document.querySelector('%s').shadowRoot.querySelector('%s')",rootElementId,cssLocator);
        WebElement ele = (WebElement) ((JavascriptExecutor) DriverManager.getDriver())
